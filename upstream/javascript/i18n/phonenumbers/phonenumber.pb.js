...
i18n.phonenumbers.PhoneNumber.prototype.getCountryCodeSourceOrDefault = function () {
  return /** @type {!i18n.phonenumbers.PhoneNumber.CountryCodeSource} */ (
    this.get$ValueOrDefault(6)
  )
}
...
i18n.phonenumbers.PhoneNumber.prototype.getDescriptor = function () {
  ...
  if (!descriptor) {
    ...
    i18n.phonenumbers.PhoneNumber.descriptor_ = descriptor = goog.proto2.Message.createDescriptor(
