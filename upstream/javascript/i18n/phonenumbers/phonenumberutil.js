 ...
 * @type {!RegExp}
 */
i18n.phonenumbers.PhoneNumberUtil.PLUS_CHARS_PATTERN = new RegExp(
  "[" + i18n.phonenumbers.PhoneNumberUtil.PLUS_CHARS_ + "]+"
)
 ...
 * @package
 */
i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN = new RegExp(
  "^[" + i18n.phonenumbers.PhoneNumberUtil.PLUS_CHARS_ + "]+"
)
 ...
 * @type {!RegExp}
 */
i18n.phonenumbers.PhoneNumberUtil.CAPTURING_DIGIT_PATTERN = new RegExp(
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.RFC3966_GLOBAL_NUMBER_DIGITS_PATTERN_ = new RegExp(
  i18n.phonenumbers.PhoneNumberUtil.RFC3966_GLOBAL_NUMBER_DIGITS_
)
...
i18n.phonenumbers.PhoneNumberUtil.ALPHANUM_ =
  i18n.phonenumbers.PhoneNumberUtil.VALID_ALPHA_ + i18n.phonenumbers.PhoneNumberUtil.VALID_DIGITS_
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.RFC3966_DOMAINNAME_PATTERN_ = new RegExp(
  i18n.phonenumbers.PhoneNumberUtil.RFC3966_DOMAINNAME_
)
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.extnDigits_ = function (maxLength) {
  return "([" + i18n.phonenumbers.PhoneNumberUtil.VALID_DIGITS_ + "]" + "{1," + maxLength + "})"
}
...
i18n.phonenumbers.PhoneNumberUtil.createExtnPattern_ = function () {
  ...
  var americanStyleExtnWithSuffix =
    ambiguousSeparator + i18n.phonenumbers.PhoneNumberUtil.extnDigits_(extLimitWhenNotSure) + "#"
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.EXTN_PATTERN_ = new RegExp(
...
i18n.phonenumbers.PhoneNumberUtil.extractPossibleNumber = function (number) {
  ...
  if (start >= 0) {
    ...
    /** @type {number} */
    var secondNumberStart = possibleNumber.search(
...
i18n.phonenumbers.PhoneNumberUtil.normalize = function (number) {
  if (
    ...
    return i18n.phonenumbers.PhoneNumberUtil.normalizeHelper_(
      number,
      i18n.phonenumbers.PhoneNumberUtil.ALL_NORMALIZATION_MAPPINGS_,
      true
    )
...
i18n.phonenumbers.PhoneNumberUtil.prototype.getLengthOfNationalDestinationCode = function (number) {
  ...
  /** @type {string} */
  var nationalSignificantNumber = this.format(
    copiedProto,
...
i18n.phonenumbers.PhoneNumberUtil.prototype.getSupportedRegions = function () {
  return Object.keys(i18n.phonenumbers.metadata.countryToMetadata).filter(function (regionCode) {
...
i18n.phonenumbers.PhoneNumberUtil.prototype.getSupportedGlobalNetworkCallingCodes = function () {
  var callingCodesAsStrings = Object.keys(i18n.phonenumbers.metadata.countryToMetadata).filter(
    function (regionCode) {
      return !isNaN(regionCode)
    }
  )
...
i18n.phonenumbers.PhoneNumberUtil.prototype.getSupportedTypesForRegion = function (regionCode) {
  ...
  return i18n.phonenumbers.PhoneNumberUtil.getSupportedTypesForMetadata_(
    /** @type {!i18n.phonenumbers.PhoneMetadata} */ (this.getMetadataForRegion(regionCode))
  )
}
 ...
 *   non-geographical entity the library supports.
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.getSupportedTypesForNonGeoEntity = function (
  countryCallingCode
) {
  /** @type {i18n.phonenumbers.PhoneMetadata} */
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.normalizeHelper_ = function (
  number,
 ...
 *     group only.
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.formattingRuleHasFirstGroupOnly = function (
  nationalPrefixFormattingRule
) {
  return (
    nationalPrefixFormattingRule.length == 0 ||
    i18n.phonenumbers.PhoneNumberUtil.FIRST_GROUP_ONLY_PREFIX_PATTERN_.test(
      nationalPrefixFormattingRule
    )
  )
}
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.hasValidCountryCallingCode_ = function (
  countryCallingCode
) {
    ...
    if (nationalPrefixFormattingRule.length > 0) {
      ...
      if (nationalPrefix.length > 0) {
        ...
        nationalPrefixFormattingRule = nationalPrefixFormattingRule
          .replace(i18n.phonenumbers.PhoneNumberUtil.NP_PATTERN_, nationalPrefix)
 ...
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.formatNationalNumberWithCarrierCode = function (
  number,
  carrierCode
) {
  /** @type {number} */
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.getMetadataForRegionOrCallingCode_ = function (
  countryCallingCode,
  regionCode
) {
  return i18n.phonenumbers.PhoneNumberUtil.REGION_CODE_FOR_NON_GEO_ENTITY == regionCode
 ...
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.formatNationalNumberWithPreferredCarrierCode =
  function (number, fallbackCarrierCode) {
 ...
 * @return {string} the formatted phone number.
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.formatNumberForMobileDialing = function (
  number,
  regionCallingFrom,
  withFormatting
) {
  ...
  if (regionCallingFrom == regionCode) {
    ...
    if (regionCode == "BR" && isFixedLineOrMobile) {
      formattedNumber =
        ...
        numberNoExt.getPreferredDomesticCarrierCodeOrDefault().length > 0
          ...
          : // Brazilian fixed line and mobile numbers need to be dialed with a
            ...
            // empty string here.
            ""
    } else if (countryCallingCode == i18n.phonenumbers.PhoneNumberUtil.NANPA_COUNTRY_CODE_) {
      ...
      if (
        ...
        this.testNumberLength_(this.getNationalSignificantNumber(numberNoExt), regionMetadata) !=
      ...
      if (
        (regionCode == i18n.phonenumbers.PhoneNumberUtil.REGION_CODE_FOR_NON_GEO_ENTITY ||
    ...
    return withFormatting
      ? this.format(numberNoExt, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL)
      : this.format(numberNoExt, i18n.phonenumbers.PhoneNumberFormat.E164)
  }
  return withFormatting
    ? formattedNumber
    : i18n.phonenumbers.PhoneNumberUtil.normalizeDiallableCharsOnly(formattedNumber)
}
 ...
 * @return {string} the formatted phone number.
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.formatOutOfCountryCallingNumber = function (
  number,
  regionCallingFrom
) {
  ...
  if (countryCallingCode == i18n.phonenumbers.PhoneNumberUtil.NANPA_COUNTRY_CODE_) {
    if (this.isNANPACountry(regionCallingFrom)) {
      ...
      return (
        countryCallingCode + " " + this.format(number, i18n.phonenumbers.PhoneNumberFormat.NATIONAL)
      )
    }
  } else if (countryCallingCode == this.getCountryCodeForValidRegion_(regionCallingFrom)) {
 ...
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.formatInOriginalFormat = function (
  number,
  regionCallingFrom
) {
  ...
  switch (number.getCountryCodeSource()) {
    ...
    default:
      ...
      // prefix.
      if (
        this.rawInputContainsNationalPrefix_(
          number.getRawInputOrDefault(),
          nationalPrefix,
          regionCode
        )
      ) {
      ...
      candidateNationalPrefixRule = i18n.phonenumbers.PhoneNumberUtil.normalizeDigitsOnly(
      ...
      numFormatCopy.clearNationalPrefixFormattingRule()
      formattedNumber = this.formatByPattern(number, i18n.phonenumbers.PhoneNumberFormat.NATIONAL, [
        numFormatCopy
      ])
      break
  }
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.rawInputContainsNationalPrefix_ = function (
  rawInput,
  nationalPrefix,
  regionCode
) {
  ...
  if (goog.string.startsWith(normalizedNationalNumber, nationalPrefix)) {
    try {
      ...
      return this.isValidNumber(
        this.parse(normalizedNationalNumber.substring(nationalPrefix.length), regionCode)
      )
    } catch (e) {
      return false
    }
 ...
 * @return {string} the formatted phone number.
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.formatOutOfCountryKeepingAlphaChars = function (
  number,
  regionCallingFrom
) {
  /** @type {string} */
  ...
  if (countryCode == i18n.phonenumbers.PhoneNumberUtil.NANPA_COUNTRY_CODE_) {
    ...
    metadataForRegionCallingFrom != null &&
    countryCode == this.getCountryCodeForValidRegion_(regionCallingFrom)
  ) {
    /** @type {i18n.phonenumbers.NumberFormat} */
    var formattingPattern = this.chooseFormattingPatternForNumber_(
      metadataForRegionCallingFrom.numberFormatArray(),
      nationalNumber
    )
    if (formattingPattern == null) {
    ...
    // metadata to date.
    return this.formatNsnUsingPattern_(
      rawInput,
      newFormat,
      i18n.phonenumbers.PhoneNumberFormat.NATIONAL
    )
  ...
  if (metadataForRegionCallingFrom != null) {
    /** @type {string} */
    var internationalPrefix = metadataForRegionCallingFrom.getInternationalPrefixOrDefault()
    internationalPrefixForFormatting = i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(
      i18n.phonenumbers.PhoneNumberUtil.SINGLE_INTERNATIONAL_PREFIX_,
      internationalPrefix
    )
      ? internationalPrefix
  ...
  if (internationalPrefixForFormatting.length > 0) {
    return (
      internationalPrefixForFormatting + " " + countryCode + " " + rawInput + formattedExtension
    )
  } else {
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.prefixNumberWithCountryCallingCode_ = function (
  countryCallingCode,
  numberFormat,
  formattedNationalNumber,
  formattedExtension
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.formatNsn_ = function (
  number,
  metadata,
  numberFormat,
  opt_carrierCode
  ...
  var availableFormats =
    intlNumberFormats.length == 0 || numberFormat == i18n.phonenumbers.PhoneNumberFormat.NATIONAL
      ? metadata.numberFormatArray()
      : metadata.intlNumberFormatArray()
  /** @type {i18n.phonenumbers.NumberFormat} */
  var formattingPattern = this.chooseFormattingPatternForNumber_(availableFormats, number)
  return formattingPattern == null
    ? number
    : this.formatNsnUsingPattern_(number, formattingPattern, numberFormat, opt_carrierCode)
}
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.chooseFormattingPatternForNumber_ = function (
  availableFormats,
  nationalNumber
) {
  /** @type {i18n.phonenumbers.NumberFormat} */
  ...
  for (var i = 0; i < l; ++i) {
    ...
    if (
      ...
      // detailed.
      nationalNumber.search(numFormat.getLeadingDigitsPattern(size - 1)) == 0
    ) {
      /** @type {!RegExp} */
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.formatNsnUsingPattern_ = function (
  nationalNumber,
  formattingPattern,
  numberFormat,
  opt_carrierCode
  ...
  if (
    ...
    opt_carrierCode.length > 0 &&
    domesticCarrierCodeFormattingRule.length > 0
  ) {
    // Replace the $CC in the formatting rule with the desired carrier code.
    /** @type {string} */
    var carrierCodeFormattingRule = domesticCarrierCodeFormattingRule.replace(
 ...
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.getExampleNumberForNonGeoEntity = function (
  countryCallingCode
) {
  /** @type {i18n.phonenumbers.PhoneMetadata} */
  var metadata = this.getMetadataForNonGeographicalRegion(countryCallingCode)
  if (metadata != null) {
    ...
    if (numberTypeWithExampleNumber !== undefined) {
      try {
        return this.parse(
          "+" + countryCallingCode + numberTypeWithExampleNumber.getExampleNumber(),
          "ZZ"
        )
      } catch (e) {}
    }
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.maybeGetFormattedExtension_ = function (
  number,
  metadata,
  numberFormat
) {
  if (!number.hasExtension() || number.getExtension().length == 0) {
    ...
    if (numberFormat == i18n.phonenumbers.PhoneNumberFormat.RFC3966) {
      ...
      if (metadata.hasPreferredExtnPrefix()) {
        ...
        return (
          i18n.phonenumbers.PhoneNumberUtil.DEFAULT_EXTN_PREFIX_ + number.getExtensionOrDefault()
        )
      }
    }
  }
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.getNumberTypeHelper_ = function (
  nationalNumber,
  metadata
) {
  ...
  if (isFixedLine) {
    ...
    } else if (this.isNumberMatchingDesc_(nationalNumber, metadata.getMobile())) {
      return i18n.phonenumbers.PhoneNumberType.FIXED_LINE_OR_MOBILE
    }
  ...
  if (
    !metadata.getSameMobileAndFixedLinePattern() &&
...
i18n.phonenumbers.PhoneNumberUtil.prototype.getMetadataForRegion = function (regionCode) {
  ...
  if (metadata == null) {
    ...
    metadata = /** @type {i18n.phonenumbers.PhoneMetadata} */ (
      serializer.deserialize(i18n.phonenumbers.PhoneMetadata.getDescriptor(), metadataSerialized)
    )
 ...
 * @return {?i18n.phonenumbers.PhoneMetadata}
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.getMetadataForNonGeographicalRegion = function (
  countryCallingCode
) {
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.isNumberMatchingDesc_ = function (
  nationalNumber,
  numberDesc
) {
  ...
  if (
    numberDesc.possibleLengthCount() > 0 &&
    numberDesc.possibleLengthArray().indexOf(actualLength) == -1
  ) {
    return false
  }
  return i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(
    numberDesc.getNationalNumberPatternOrDefault(),
    nationalNumber
  )
}
...
i18n.phonenumbers.PhoneNumberUtil.prototype.isValidNumberForRegion = function (number, regionCode) {
  ...
  if (
    metadata == null ||
    (i18n.phonenumbers.PhoneNumberUtil.REGION_CODE_FOR_NON_GEO_ENTITY != regionCode &&
  ...
  return (
    this.getNumberTypeHelper_(nationalSignificantNumber, metadata) !=
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.getRegionCodeForNumberFromRegionList_ = function (
  number,
  regionCodes
) {
  /** @type {string} */
  ...
  for (var i = 0; i < regionCodesLength; i++) {
    ...
    if (metadata.hasLeadingDigits()) {
      ...
      this.getNumberTypeHelper_(nationalNumber, metadata) !=
      i18n.phonenumbers.PhoneNumberType.UNKNOWN
    ) {
      return regionCode
    }
 ...
 * @return {string}
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.getRegionCodeForCountryCode = function (
  countryCallingCode
) {
  /** @type {Array.<string>} */
 ...
 * @return {!Array.<string>}
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.getRegionCodesForCountryCode = function (
  countryCallingCode
) {
  /** @type {Array.<string>} */
  var regionCodes = i18n.phonenumbers.metadata.countryCodeToRegionCodeMap[countryCallingCode]
...
i18n.phonenumbers.PhoneNumberUtil.prototype.isPossibleNumber = function (number) {
  ...
  return (
    result == i18n.phonenumbers.PhoneNumberUtil.ValidationResult.IS_POSSIBLE ||
    result == i18n.phonenumbers.PhoneNumberUtil.ValidationResult.IS_POSSIBLE_LOCAL_ONLY
  )
}
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.testNumberLengthForType_ = function (
  number,
  metadata,
  type
) {
  ...
  // real phone number).
  var possibleLengths =
    descForType.possibleLengthCount() == 0
 ...
 *     ValidationResult object which indicates whether the number is possible
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.isPossibleNumberForTypeWithReason = function (
  number,
  type
) {
  /** @type {string} */
 ...
 * @return {boolean} true if the number is possible.
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.isPossibleNumberString = function (
  number,
  regionDialingFrom
) {
  try {
 ...
 * @return {number}
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.extractCountryCode = function (
  fullNumber,
  nationalNumber
) {
  /** @type {string} */
  ...
  for (
    var i = 1;
    i <= i18n.phonenumbers.PhoneNumberUtil.MAX_LENGTH_COUNTRY_CODE_ && i <= numberLength;
    ++i
  ) {
 ...
 * @throws {Error}
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.maybeExtractCountryCode = function (
  number,
    ...
    if (goog.string.startsWith(normalizedNumber, defaultCountryCodeString)) {
      ...
      if (
        (!i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(
          ...
          i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(
            validNumberPattern,
            potentialNationalNumberStr
          )) ||
        this.testNumberLength_(fullNumber.toString(), defaultRegionMetadata) ==
        ...
        if (keepRawInput) {
          phoneNumber.setCountryCodeSource(
            i18n.phonenumbers.PhoneNumber.CountryCodeSource.FROM_NUMBER_WITHOUT_PLUS_SIGN
          )
        }
 ...
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.maybeStripInternationalPrefixAndNormalize = function (
  number,
  possibleIddPrefix
) {
  /** @type {string} */
 ...
 *     be extracted.
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.maybeStripNationalPrefixAndCarrierCode = function (
  number,
  metadata,
  carrierCode
) {
  ...
  if (prefixMatcher) {
    ...
    /** @type {boolean} */
    var isViableOriginalNumber = i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(
      nationalNumberRule,
      numberStr
    )
    ...
    if (noTransform) {
      ...
      if (
        isViableOriginalNumber &&
        !i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(nationalNumberRule, transformedNumber)
      ) {
        return false
      }
...
i18n.phonenumbers.PhoneNumberUtil.prototype.maybeStripExtension = function (number) {
  ...
  if (
    mStart >= 0 &&
    i18n.phonenumbers.PhoneNumberUtil.isViablePhoneNumber(numberStr.substring(0, mStart))
  ) {
...
i18n.phonenumbers.PhoneNumberUtil.prototype.checkRegionForParsing_ = function (
  ...
  return (
    this.isValidRegionCode_(defaultRegion) ||
    (numberToParse != null &&
      numberToParse.length > 0 &&
      i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN.test(numberToParse))
  )
}
 ...
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.parseAndKeepRawInput = function (
  numberToParse,
  defaultRegion
) {
  if (!this.isValidRegionCode_(defaultRegion)) {
    if (
      numberToParse.length > 0 &&
      numberToParse.charAt(0) != i18n.phonenumbers.PhoneNumberUtil.PLUS_SIGN
    ) {
      throw new Error(i18n.phonenumbers.Error.INVALID_COUNTRY_CODE)
    }
  }
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.setItalianLeadingZerosForPhoneNumber_ = function (
  nationalNumber,
  phoneNumber
) {
  if (nationalNumber.length > 1 && nationalNumber.charAt(0) == "0") {
    ...
    // as a leading zero.
    while (
      numberOfLeadingZeros < nationalNumber.length - 1 &&
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.parseHelper_ = function (
  numberToParse,
  defaultRegion,
  keepRawInput,
  checkRegion
  ...
  } else if (numberToParse.length > i18n.phonenumbers.PhoneNumberUtil.MAX_INPUT_STRING_LENGTH_) {
  ...
  try {
    ...
    if (
      e.message == i18n.phonenumbers.Error.INVALID_COUNTRY_CODE &&
      i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN.test(nationalNumberStr)
    ) {
  ...
  if (
    normalizedNationalNumber.getLength() < i18n.phonenumbers.PhoneNumberUtil.MIN_LENGTH_FOR_NSN_
  ) {
  ...
  if (regionMetadata != null) {
    ...
    var validationResult = this.testNumberLength_(
      potentialNationalNumber.toString(),
      regionMetadata
    )
    var validationResults = i18n.phonenumbers.PhoneNumberUtil.ValidationResult
    if (
      validationResult != validationResults.TOO_SHORT &&
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.extractPhoneContext_ = function (numberToExtractFrom) {
  /** @type {number} */
  var indexOfPhoneContext = numberToExtractFrom.indexOf(
  ...
  /** @type {number} */
  var phoneContextStart =
    indexOfPhoneContext + i18n.phonenumbers.PhoneNumberUtil.RFC3966_PHONE_CONTEXT_.length
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.isPhoneContextValid_ = function (phoneContext) {
  ...
  var globalNumberDigitsMatcher =
    i18n.phonenumbers.PhoneNumberUtil.RFC3966_GLOBAL_NUMBER_DIGITS_PATTERN_.exec(phoneContext)
  var domainnameMatcher =
    i18n.phonenumbers.PhoneNumberUtil.RFC3966_DOMAINNAME_PATTERN_.exec(phoneContext)
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.buildNationalNumberForParsing_ = function (
  numberToParse,
  nationalNumber
) {
  var phoneContext = i18n.phonenumbers.PhoneNumberUtil.prototype.extractPhoneContext_(numberToParse)

  if (!i18n.phonenumbers.PhoneNumberUtil.prototype.isPhoneContextValid_(phoneContext)) {
    throw new Error(i18n.phonenumbers.Error.NOT_A_NUMBER)
  }
  if (phoneContext != null) {
    // If the phone context contains a phone number prefix, we need to capture
    // it, whereas domains will be ignored.
    if (phoneContext.charAt(0) === i18n.phonenumbers.PhoneNumberUtil.PLUS_SIGN) {
    ...
    var indexOfNationalNumber =
      indexOfRfc3966Prefix >= 0
        ? indexOfRfc3966Prefix + i18n.phonenumbers.PhoneNumberUtil.RFC3966_PREFIX_.length
        : 0
 ...
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.isNumberMatch = function (
  firstNumberIn,
  secondNumberIn
) {
  ...
  if (
    firstNumberToCompare.hasExtension() &&
    secondNumberToCompare.hasExtension() &&
    firstNumberToCompare.getExtension() != secondNumberToCompare.getExtension()
  ) {
  ...
  if (firstNumberCountryCode != 0 && secondNumberCountryCode != 0) {
    if (firstNumberToCompare.equals(secondNumberToCompare)) {
      ...
      firstNumberCountryCode == secondNumberCountryCode &&
      this.isNationalNumberSuffixOfTheOther_(firstNumberToCompare, secondNumberToCompare)
    ) {
 ...
 * @private
 */
i18n.phonenumbers.PhoneNumberUtil.prototype.isNationalNumberSuffixOfTheOther_ = function (
  firstNumber,
  secondNumber
) {
  /** @type {string} */
  ...
  return (
    goog.string.endsWith(firstNumberNationalNumber, secondNumberNationalNumber) ||
    goog.string.endsWith(secondNumberNationalNumber, firstNumberNationalNumber)
  )
}
...
i18n.phonenumbers.PhoneNumberUtil.matchesEntirely = function (regex, str) {
  /** @type {Array.<string>} */
  var matchedGroups = str.match(
    new RegExp("^(?:" + (typeof regex == "string" ? regex : regex.source) + ")$", "i")
  )
