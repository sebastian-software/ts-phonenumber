 ...
 */
i18n.phonenumbers.NumberFormat.prototype.setNationalPrefixOptionalWhenFormatting = function (
  value
) {
 ...
 * @return {string} The value.
 */
i18n.phonenumbers.NumberFormat.prototype.getDomesticCarrierCodeFormattingRuleOrDefault =
  function () {
...
i18n.phonenumbers.NumberFormat.prototype.getDescriptor = function () {
  ...
  if (!descriptor) {
    ...
    i18n.phonenumbers.NumberFormat.descriptor_ = descriptor = goog.proto2.Message.createDescriptor(
...
i18n.phonenumbers.PhoneNumberDesc.prototype.getDescriptor = function () {
  ...
  if (!descriptor) {
    ...
    i18n.phonenumbers.PhoneNumberDesc.descriptor_ = descriptor =
      goog.proto2.Message.createDescriptor(i18n.phonenumbers.PhoneNumberDesc, descriptorObj)
  }
  return descriptor
}
...
i18n.phonenumbers.PhoneMetadata.prototype.getDescriptor = function () {
  ...
  if (!descriptor) {
    ...
    i18n.phonenumbers.PhoneMetadata.descriptor_ = descriptor = goog.proto2.Message.createDescriptor(
...
i18n.phonenumbers.PhoneMetadataCollection.prototype.getDescriptor = function () {
  ...
  if (!descriptor) {
    ...
    i18n.phonenumbers.PhoneMetadataCollection.descriptor_ = descriptor =
      goog.proto2.Message.createDescriptor(i18n.phonenumbers.PhoneMetadataCollection, descriptorObj)
  }
  return descriptor
}
