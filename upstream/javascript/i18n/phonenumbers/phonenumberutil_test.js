...
function testGetInstanceLoadUSMetadata() {
  ...
  assertEquals("(\\d{3})(\\d{3})(\\d{4})", metadata.getNumberFormat(1).getPattern())
  ...
  assertEquals("[13-689]\\d{9}|2[0-35-9]\\d{8}", metadata.getFixedLine().getNationalNumberPattern())
...
function testGetInstanceLoadDEMetadata() {
  ...
  assertEquals("(\\d{3})(\\d{3,4})(\\d{4})", metadata.getNumberFormat(5).getPattern())
...
function testGetInstanceLoadARMetadata() {
  ...
  assertEquals("(\\d)(\\d{4})(\\d{2})(\\d{4})", metadata.getNumberFormat(3).getPattern())
  assertEquals("(\\d)(\\d{4})(\\d{2})(\\d{4})", metadata.getIntlNumberFormat(3).getPattern())
...
function testGetSupportedGlobalNetworkCallingCodes() {
  ...
  phoneUtil.getSupportedGlobalNetworkCallingCodes().forEach(function (countryCallingCode) {
    assertEquals(RegionCode.UN001, phoneUtil.getRegionCodeForCountryCode(countryCallingCode))
  })
}
...
function testGetSupportedCallingCodes() {
  ...
  phoneUtil.getSupportedCallingCodes().forEach(function (callingCode) {
    ...
    assertFalse(phoneUtil.getRegionCodeForCountryCode(callingCode) == RegionCode.ZZ)
  })
...
function testGetExampleNumber() {
  ...
  assertTrue(DE_NUMBER.equals(phoneUtil.getExampleNumberForType(RegionCode.DE, PNT.FIXED_LINE)))

  // Should return the same response if asked for FIXED_LINE_OR_MOBILE too.
  assertTrue(
    DE_NUMBER.equals(phoneUtil.getExampleNumberForType(RegionCode.DE, PNT.FIXED_LINE_OR_MOBILE))
  )
  ...
  assertNotNull(phoneUtil.getExampleNumberForType(RegionCode.US, PNT.FIXED_LINE))
...
function testGetExampleNumberForNonGeoEntity() {
  assertTrue(INTERNATIONAL_TOLL_FREE.equals(phoneUtil.getExampleNumberForNonGeoEntity(800)))
  assertTrue(UNIVERSAL_PREMIUM_RATE.equals(phoneUtil.getExampleNumberForNonGeoEntity(979)))
}
...
function testNormaliseStripNonDiallableCharacters() {
  ...
  assertEquals(
    ...
    expectedOutput,
    i18n.phonenumbers.PhoneNumberUtil.normalizeDiallableCharsOnly(inputNumber)
  )
}
...
function testFormatUSNumber() {
  ...
  assertEquals("+1 650 253 0000", phoneUtil.format(US_NUMBER, PNF.INTERNATIONAL))

  assertEquals("800 253 0000", phoneUtil.format(US_TOLLFREE, PNF.NATIONAL))
  assertEquals("+1 800 253 0000", phoneUtil.format(US_TOLLFREE, PNF.INTERNATIONAL))

  assertEquals("900 253 0000", phoneUtil.format(US_PREMIUM, PNF.NATIONAL))
  assertEquals("+1 900 253 0000", phoneUtil.format(US_PREMIUM, PNF.INTERNATIONAL))
  assertEquals("tel:+1-900-253-0000", phoneUtil.format(US_PREMIUM, PNF.RFC3966))
  ...
  // specified.
  assertEquals("000-000-0000", phoneUtil.format(US_SPOOF_WITH_RAW_INPUT, PNF.NATIONAL))
...
function testFormatBSNumber() {
  ...
  assertEquals("+1 242 365 1234", phoneUtil.format(BS_NUMBER, PNF.INTERNATIONAL))
}

function testFormatGBNumber() {
  var PNF = i18n.phonenumbers.PhoneNumberFormat
  assertEquals("(020) 7031 3000", phoneUtil.format(GB_NUMBER, PNF.NATIONAL))
  assertEquals("+44 20 7031 3000", phoneUtil.format(GB_NUMBER, PNF.INTERNATIONAL))

  assertEquals("(07912) 345 678", phoneUtil.format(GB_MOBILE, PNF.NATIONAL))
  assertEquals("+44 7912 345 678", phoneUtil.format(GB_MOBILE, PNF.INTERNATIONAL))
}
...
function testFormatDENumber() {
  ...
  assertEquals("+49 291 12345678", phoneUtil.format(deNumber, PNF.INTERNATIONAL))
  ...
  assertEquals("+49 1234", phoneUtil.format(DE_SHORT_NUMBER, PNF.INTERNATIONAL))
...
function testFormatITNumber() {
  ...
  assertEquals("+39 02 3661 8300", phoneUtil.format(IT_NUMBER, PNF.INTERNATIONAL))
  ...
  assertEquals("+39 345 678 901", phoneUtil.format(IT_MOBILE, PNF.INTERNATIONAL))
...
function testFormatAUNumber() {
  ...
  assertEquals("+61 2 3661 8300", phoneUtil.format(AU_NUMBER, PNF.INTERNATIONAL))
  ...
  assertEquals("+61 1800 123 456", phoneUtil.format(auNumber, PNF.INTERNATIONAL))
...
function testFormatARNumber() {
  ...
  assertEquals("+54 11 8765-4321", phoneUtil.format(AR_NUMBER, PNF.INTERNATIONAL))
  ...
  assertEquals("+54 9 11 8765 4321", phoneUtil.format(AR_MOBILE, PNF.INTERNATIONAL))
...
function testFormatMXNumber() {
  ...
  assertEquals("+52 1 234 567 8900", phoneUtil.format(MX_MOBILE1, PNF.INTERNATIONAL))
  ...
  assertEquals("+52 1 55 1234 5678", phoneUtil.format(MX_MOBILE2, PNF.INTERNATIONAL))
  ...
  assertEquals("+52 33 1234 5678", phoneUtil.format(MX_NUMBER1, PNF.INTERNATIONAL))
  ...
  assertEquals("+52 821 123 4567", phoneUtil.format(MX_NUMBER2, PNF.INTERNATIONAL))
...
function testFormatOutOfCountryCallingNumber() {
  ...
  assertEquals("02 3661 8300", phoneUtil.formatOutOfCountryCallingNumber(IT_NUMBER, RegionCode.IT))
  assertEquals(
    "+39 02 3661 8300",
    phoneUtil.formatOutOfCountryCallingNumber(IT_NUMBER, RegionCode.SG)
  )

  assertEquals("6521 8000", phoneUtil.formatOutOfCountryCallingNumber(SG_NUMBER, RegionCode.SG))
...
function testFormatWithCarrierCode() {
  ...
  assertEquals("02234 14 65-4321", phoneUtil.formatNationalNumberWithCarrierCode(arMobile, "14"))
  // Here we force the number to be shown with no carrier code.
  assertEquals("02234 65-4321", phoneUtil.formatNationalNumberWithCarrierCode(arMobile, ""))
...
function testFormatNumberForMobileDialing() {
  ...
  assertEquals("030123456", phoneUtil.formatNumberForMobileDialing(DE_NUMBER, RegionCode.DE, false))
  assertEquals(
    "+4930123456",
  ...
  assertEquals("*2345", phoneUtil.formatNumberForMobileDialing(JP_STAR_NUMBER, RegionCode.JP, true))
  ...
  assertEquals("600123456", phoneUtil.formatNumberForMobileDialing(AE_UAN, RegionCode.AE, false))
  ...
  assertEquals("123", phoneUtil.formatNumberForMobileDialing(deShortNumber, RegionCode.DE, false))
  ...
  assertEquals("911", phoneUtil.formatNumberForMobileDialing(usShortNumber, RegionCode.US, false))
  ...
  assertEquals("000", phoneUtil.formatNumberForMobileDialing(auShortNumber, RegionCode.AU, false))
  assertEquals("", phoneUtil.formatNumberForMobileDialing(auShortNumber, RegionCode.NZ, false))
}
...
function testFormatByPattern() {
  ...
  assertEquals("(650) 253-0000", phoneUtil.formatByPattern(US_NUMBER, PNF.NATIONAL, [newNumFormat]))
  assertEquals(
    "+1 (650) 253-0000",
  ...
  assertEquals("02-36618 300", phoneUtil.formatByPattern(IT_NUMBER, PNF.NATIONAL, [newNumFormat]))
  assertEquals(
    "+39 02-36618 300",
  ...
  newNumFormat.setFormat("$1 $2 $3")
  assertEquals("020 7031 3000", phoneUtil.formatByPattern(GB_NUMBER, PNF.NATIONAL, [newNumFormat]))
  ...
  assertEquals("20 7031 3000", phoneUtil.formatByPattern(GB_NUMBER, PNF.NATIONAL, [newNumFormat]))
...
function testFormatE164Number() {
  ...
  assertEquals("+80012345678", phoneUtil.format(INTERNATIONAL_TOLL_FREE, PNF.E164))
}
...
function testFormatNumberWithExtension() {
  ...
  assertEquals("03-331 6005 ext. 1234", phoneUtil.format(nzNumber, PNF.NATIONAL))
  // Uses RFC 3966 syntax.
  assertEquals("tel:+64-3-331-6005;ext=1234", phoneUtil.format(nzNumber, PNF.RFC3966))
  // Extension prefix overridden in the territory information for the US:
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var usNumberWithExtension = US_NUMBER.clone()
  usNumberWithExtension.setExtension("4567")
  assertEquals("650 253 0000 extn. 4567", phoneUtil.format(usNumberWithExtension, PNF.NATIONAL))
}
...
function testFormatInOriginalFormat() {
  ...
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var numberWithNationalPrefixUS = phoneUtil.parseAndKeepRawInput("18003456789", RegionCode.US)
  assertEquals(
    "1 800 345 6789",
  ...
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var numberWithoutNationalPrefixGB = phoneUtil.parseAndKeepRawInput("2087654321", RegionCode.GB)
  assertEquals(
    "20 8765 4321",
  ...
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var numberWithNationalPrefixMX = phoneUtil.parseAndKeepRawInput("013312345678", RegionCode.MX)
  assertEquals(
    "01 33 1234 5678",
  ...
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var numberWithoutNationalPrefixMX = phoneUtil.parseAndKeepRawInput("3312345678", RegionCode.MX)
  assertEquals(
    "33 1234 5678",
  ...
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var italianFixedLineNumber = phoneUtil.parseAndKeepRawInput("0212345678", RegionCode.IT)
  assertEquals(
    "02 1234 5678",
  ...
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var numberWithNationalPrefixJP = phoneUtil.parseAndKeepRawInput("00777012", RegionCode.JP)
  assertEquals(
    "0077-7012",
  ...
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var numberWithoutNationalPrefixJP = phoneUtil.parseAndKeepRawInput("0777012", RegionCode.JP)
  assertEquals(
    "0777012",
  ...
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var numberWithCarrierCodeBR = phoneUtil.parseAndKeepRawInput("012 3121286979", RegionCode.BR)
  assertEquals(
    "012 3121286979",
  ...
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var numberWithNationalPrefixMX1 = phoneUtil.parseAndKeepRawInput(
    "044(33)1234-5678",
    RegionCode.MX
  )
  assertEquals(
  ...
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var numberWithNationalPrefixMX2 = phoneUtil.parseAndKeepRawInput(
    "045(33)1234-5678",
    RegionCode.MX
  )
  assertEquals(
  ...
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var outOfCountryNumberFromAU1 = phoneUtil.parseAndKeepRawInput("0012 16502530000", RegionCode.AU)
  assertEquals(
    "0012 16502530000",
  ...
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var outOfCountryNumberFromAU2 = phoneUtil.parseAndKeepRawInput("0011 16502530000", RegionCode.AU)
  assertEquals(
    "0011 1 650 253 0000",
  ...
  // national number.
  assertEquals("650253000", phoneUtil.formatInOriginalFormat(US_SHORT_BY_ONE_NUMBER, RegionCode.US))
}
...
function testIsPremiumRate() {
  ...
  assertEquals(PNT.PREMIUM_RATE, phoneUtil.getNumberType(premiumRateNumber))
  assertEquals(PNT.PREMIUM_RATE, phoneUtil.getNumberType(UNIVERSAL_PREMIUM_RATE))
}
...
function testIsFixedLineAndMobile() {
  ...
  assertEquals(PNT.FIXED_LINE_OR_MOBILE, phoneUtil.getNumberType(fixedLineAndMobileNumber))
}
...
function testGetRegionCodesForCountryCode() {
  ...
  assertTrue(phoneUtil.getRegionCodesForCountryCode(44).includes(RegionCode.GB))
  assertTrue(phoneUtil.getRegionCodesForCountryCode(49).includes(RegionCode.DE))
  assertTrue(phoneUtil.getRegionCodesForCountryCode(800).includes(RegionCode.UN001))
...
function testIsPossibleNumber() {
  ...
  assertTrue(phoneUtil.isPossibleNumberString("+1 650 253 0000", RegionCode.GB))
  assertTrue(phoneUtil.isPossibleNumberString("+44 20 7031 3000", RegionCode.GB))
  assertTrue(phoneUtil.isPossibleNumberString("(020) 7031 3000", RegionCode.GB))
  ...
  assertTrue(phoneUtil.isPossibleNumberString("+800 1234 5678", RegionCode.UN001))
}
...
function testIsPossibleNumberForType_NumberTypeNotSupportedForRegion() {
  ...
  assertTrue(phoneUtil.isPossibleNumberForType(number, PNT.FIXED_LINE))
  assertTrue(phoneUtil.isPossibleNumberForType(number, PNT.FIXED_LINE_OR_MOBILE))
  ...
  assertFalse(phoneUtil.isPossibleNumberForType(number, PNT.MOBILE))
  assertFalse(phoneUtil.isPossibleNumberForType(number, PNT.FIXED_LINE))
  assertFalse(phoneUtil.isPossibleNumberForType(number, PNT.FIXED_LINE_OR_MOBILE))
...
function testIsPossibleNumberWithReason() {
  ...
  assertEquals(VR.IS_POSSIBLE_LOCAL_ONLY, phoneUtil.isPossibleNumberWithReason(US_LOCAL_NUMBER))

  assertEquals(VR.TOO_LONG, phoneUtil.isPossibleNumberWithReason(US_LONG_NUMBER))

  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var number = new i18n.phonenumbers.PhoneNumber()
  number.setCountryCode(0)
  number.setNationalNumber(2530000)
  assertEquals(VR.INVALID_COUNTRY_CODE, phoneUtil.isPossibleNumberWithReason(number))
  ...
  assertEquals(VR.TOO_LONG, phoneUtil.isPossibleNumberWithReason(INTERNATIONAL_TOLL_FREE_TOO_LONG))
}
...
function testIsPossibleNumberForTypeWithReason_DifferentTypeLengths() {
  ...
  assertEquals(VR.TOO_SHORT, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.UNKNOWN))
  assertEquals(VR.TOO_SHORT, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.FIXED_LINE))

  // 6-digit numbers are okay for fixed-line.
  number.setNationalNumber(123456)
  assertEquals(VR.IS_POSSIBLE, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.UNKNOWN))
  assertEquals(VR.IS_POSSIBLE, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.FIXED_LINE))
  // But too short for mobile.
  assertEquals(VR.TOO_SHORT, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.MOBILE))
  // And too short for toll-free.
  assertEquals(VR.TOO_SHORT, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.TOLL_FREE))
  ...
  assertEquals(VR.IS_POSSIBLE, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.UNKNOWN))
  assertEquals(VR.IS_POSSIBLE, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.FIXED_LINE))
  assertEquals(VR.IS_POSSIBLE, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.MOBILE))
  assertEquals(VR.IS_POSSIBLE, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.TOLL_FREE))
  ...
  number.setNationalNumber(12345678901)
  assertEquals(VR.IS_POSSIBLE, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.UNKNOWN))
  assertEquals(VR.TOO_LONG, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.FIXED_LINE))
  assertEquals(VR.IS_POSSIBLE, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.MOBILE))
  assertEquals(VR.TOO_LONG, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.TOLL_FREE))
}
...
function testIsPossibleNumberForTypeWithReason_NumberTypeNotSupportedForRegion() {
  ...
  number.setCountryCode(55)
  number.setNationalNumber(12345678)
  assertEquals(VR.INVALID_LENGTH, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.MOBILE))
  // This matches a fixed-line length though.
  assertEquals(
    VR.IS_POSSIBLE_LOCAL_ONLY,
    phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.FIXED_LINE_OR_MOBILE)
  )
...
function testIsPossibleNumberForTypeWithReason_FixedLineOrMobile() {
  ...
  number.setNationalNumber(12345)
  assertEquals(VR.TOO_SHORT, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.FIXED_LINE))
  assertEquals(VR.TOO_LONG, phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.MOBILE))
  assertEquals(
    VR.INVALID_LENGTH,
    phoneUtil.isPossibleNumberForTypeWithReason(number, PNT.FIXED_LINE_OR_MOBILE)
  )
...
function testIsNotPossibleNumber() {
  ...
  assertFalse(phoneUtil.isPossibleNumberString("+800 1234 5678 9", RegionCode.UN001))
}
...
function testMaybeStripNationalPrefix() {
  ...
  assertTrue(phoneUtil.maybeStripNationalPrefixAndCarrierCode(numberToStrip, metadata, carrierCode))
  ...
  assertTrue(phoneUtil.maybeStripNationalPrefixAndCarrierCode(numberToStrip, metadata, null))
  assertEquals("Should transform the 031 to a 5315.", transformedNumber, numberToStrip.toString())
}
...
function testParseNationalNumber() {
  ...
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("tel:03-331-6005;phone-context=+64", RegionCode.NZ)))
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("tel:331-6005;phone-context=+64-3", RegionCode.NZ)))
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("tel:331-6005;phone-context=+64-3", RegionCode.US)))
  assertTrue(
    NZ_NUMBER.equals(
      phoneUtil.parse("My number is tel:03-331-6005;phone-context=+64", RegionCode.NZ)
    )
  )
  // Test parsing RFC3966 format with optional user-defined parameters. The
  // parameters will appear after the context if present.
  assertTrue(
    NZ_NUMBER.equals(phoneUtil.parse("tel:03-331-6005;phone-context=+64;a=%A1", RegionCode.NZ))
  )
  // Test parsing RFC3966 with an ISDN subaddress.
  assertTrue(
    NZ_NUMBER.equals(phoneUtil.parse("tel:03-331-6005;isub=12345;phone-context=+64", RegionCode.NZ))
  )
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("tel:+64-3-331-6005;isub=12345", RegionCode.NZ)))
  // Test parsing RFC3966 with "tel:" missing.
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("03-331-6005;phone-context=+64", RegionCode.NZ)))
  // Testing international prefixes.
  // Should strip country calling code.
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("0064 3 331 6005", RegionCode.NZ)))
  ...
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("01164 3 331 6005", RegionCode.US)))
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("+64 3 331 6005", RegionCode.US)))
  ...
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("+01164 3 331 6005", RegionCode.US)))
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("+0064 3 331 6005", RegionCode.NZ)))
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("+ 00 64 3 331 6005", RegionCode.NZ)))

  assertTrue(
    US_LOCAL_NUMBER.equals(
  ...
  assertTrue(JP_STAR_NUMBER.equals(phoneUtil.parse("+81 *2345", RegionCode.JP)))
...
function testParseNumberWithAlphaCharacters() {
  ...
  assertTrue(tollfreeNumber.equals(phoneUtil.parse("0800 DDA 005", RegionCode.NZ)))
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  ...
  assertTrue(premiumNumber.equals(phoneUtil.parse("0900 DDA 6005", RegionCode.NZ)))
  // Not enough alpha characters for them to be considered intentional, so they
  // are stripped.
  assertTrue(premiumNumber.equals(phoneUtil.parse("0900 332 6005a", RegionCode.NZ)))
  assertTrue(premiumNumber.equals(phoneUtil.parse("0900 332 600a5", RegionCode.NZ)))
  assertTrue(premiumNumber.equals(phoneUtil.parse("0900 332 600A5", RegionCode.NZ)))
  assertTrue(premiumNumber.equals(phoneUtil.parse("0900 a332 600A5", RegionCode.NZ)))
}
...
function testParseMaliciousInput() {
  ...
  try {
    ...
    fail("This should not parse without throwing an exception " + maliciousNumber.toString())
  } catch (e) {
...
function testParseWithInternationalPrefixes() {
  assertTrue(US_NUMBER.equals(phoneUtil.parse("+1 (650) 253-0000", RegionCode.NZ)))
  assertTrue(INTERNATIONAL_TOLL_FREE.equals(phoneUtil.parse("011 800 1234 5678", RegionCode.US)))
  assertTrue(US_NUMBER.equals(phoneUtil.parse("1-650-253-0000", RegionCode.US)))
  // Calling the US number from Singapore by using different service providers
  // 1st test: calling using SingTel IDD service (IDD is 001)
  assertTrue(US_NUMBER.equals(phoneUtil.parse("0011-650-253-0000", RegionCode.SG)))
  // 2nd test: calling using StarHub IDD service (IDD is 008)
  assertTrue(US_NUMBER.equals(phoneUtil.parse("0081-650-253-0000", RegionCode.SG)))
  // 3rd test: calling using SingTel V019 service (IDD is 019)
  assertTrue(US_NUMBER.equals(phoneUtil.parse("0191-650-253-0000", RegionCode.SG)))
  // Calling the US number from Poland
  assertTrue(US_NUMBER.equals(phoneUtil.parse("0~01-650-253-0000", RegionCode.PL)))
  // Using '++' at the start.
  assertTrue(US_NUMBER.equals(phoneUtil.parse("++1 (650) 253-0000", RegionCode.PL)))
}

function testParseNonAscii() {
  // Using a full-width plus sign.
  assertTrue(US_NUMBER.equals(phoneUtil.parse("\uFF0B1 (650) 253-0000", RegionCode.SG)))
...
function testParseWithLeadingZero() {
  assertTrue(IT_NUMBER.equals(phoneUtil.parse("+39 02-36618 300", RegionCode.NZ)))
...
function testParseNationalNumberArgentina() {
  ...
  assertTrue(arNumber.equals(phoneUtil.parse("+54 9 343 555 1212", RegionCode.AR)))
  assertTrue(arNumber.equals(phoneUtil.parse("0343 15 555 1212", RegionCode.AR)))

  arNumber = new i18n.phonenumbers.PhoneNumber()
  arNumber.setCountryCode(54)
  arNumber.setNationalNumber(93715654320)
  assertTrue(arNumber.equals(phoneUtil.parse("+54 9 3715 65 4320", RegionCode.AR)))
  assertTrue(arNumber.equals(phoneUtil.parse("03715 15 65 4320", RegionCode.AR)))
  assertTrue(AR_MOBILE.equals(phoneUtil.parse("911 876 54321", RegionCode.AR)))

  // Test parsing fixed-line numbers of Argentina.
  assertTrue(AR_NUMBER.equals(phoneUtil.parse("+54 11 8765 4321", RegionCode.AR)))
  assertTrue(AR_NUMBER.equals(phoneUtil.parse("011 8765 4321", RegionCode.AR)))

  arNumber = new i18n.phonenumbers.PhoneNumber()
  arNumber.setCountryCode(54)
  arNumber.setNationalNumber(3715654321)
  assertTrue(arNumber.equals(phoneUtil.parse("+54 3715 65 4321", RegionCode.AR)))
  assertTrue(arNumber.equals(phoneUtil.parse("03715 65 4321", RegionCode.AR)))

  arNumber = new i18n.phonenumbers.PhoneNumber()
  arNumber.setCountryCode(54)
  arNumber.setNationalNumber(2312340000)
  assertTrue(arNumber.equals(phoneUtil.parse("+54 23 1234 0000", RegionCode.AR)))
...
function testParseWithXInNumber() {
  ...
  assertTrue(AR_NUMBER.equals(phoneUtil.parse("0 1187654321", RegionCode.AR)))
  assertTrue(AR_NUMBER.equals(phoneUtil.parse("(0xx) 1187654321", RegionCode.AR)))
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  ...
  assertTrue(arFromUs.equals(phoneUtil.parse("011xx5481429712", RegionCode.US)))
}
...
function testParseNumbersMexico() {
  ...
  assertTrue(mxNumber.equals(phoneUtil.parse("+52 (449)978-0001", RegionCode.MX)))
  assertTrue(mxNumber.equals(phoneUtil.parse("01 (449)978-0001", RegionCode.MX)))
  ...
  assertTrue(mxNumber.equals(phoneUtil.parse("+52 1 33 1234-5678", RegionCode.MX)))
  assertTrue(mxNumber.equals(phoneUtil.parse("044 (33) 1234-5678", RegionCode.MX)))
  assertTrue(mxNumber.equals(phoneUtil.parse("045 33 1234-5678", RegionCode.MX)))
}
...
function testParseNumbersWithPlusWithNoRegion() {
  ...
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("+64 3 331 6005", RegionCode.ZZ)))
  // Test with full-width plus.
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("\uFF0B64 3 331 6005", RegionCode.ZZ)))
  // Test with normal plus but leading characters that need to be stripped.
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("Tel: +64 3 331 6005", RegionCode.ZZ)))
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("+64 3 331 6005", null)))
  assertTrue(INTERNATIONAL_TOLL_FREE.equals(phoneUtil.parse("+800 1234 5678", null)))
  assertTrue(UNIVERSAL_PREMIUM_RATE.equals(phoneUtil.parse("+979 123 456 789", null)))

  // Test parsing RFC3966 format with a phone context.
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("tel:03-331-6005;phone-context=+64", RegionCode.ZZ)))
  assertTrue(
    NZ_NUMBER.equals(phoneUtil.parse("  tel:03-331-6005;phone-context=+64", RegionCode.ZZ))
  )
  assertTrue(
    NZ_NUMBER.equals(phoneUtil.parse("tel:03-331-6005;isub=12345;phone-context=+64", RegionCode.ZZ))
  )
  ...
  assertTrue(
    nzNumberWithRawInput.equals(phoneUtil.parseAndKeepRawInput("+64 3 331 6005", RegionCode.ZZ))
  )
  // Null is also allowed for the region code in these cases.
  assertTrue(nzNumberWithRawInput.equals(phoneUtil.parseAndKeepRawInput("+64 3 331 6005", null)))
}
...
function testParseExtensions() {
  ...
  assertTrue(nzNumber.equals(phoneUtil.parse("03 331 6005 ext 3456", RegionCode.NZ)))
  assertTrue(nzNumber.equals(phoneUtil.parse("03-3316005x3456", RegionCode.NZ)))
  assertTrue(nzNumber.equals(phoneUtil.parse("03-3316005 int.3456", RegionCode.NZ)))
  assertTrue(nzNumber.equals(phoneUtil.parse("03 3316005 #3456", RegionCode.NZ)))

  // Test the following do not extract extensions:
  assertTrue(ALPHA_NUMERIC_NUMBER.equals(phoneUtil.parse("1800 six-flags", RegionCode.US)))
  assertTrue(ALPHA_NUMERIC_NUMBER.equals(phoneUtil.parse("1800 SIX FLAGS", RegionCode.US)))
  assertTrue(ALPHA_NUMERIC_NUMBER.equals(phoneUtil.parse("0~0 1800 7493 5247", RegionCode.PL)))
  assertTrue(ALPHA_NUMERIC_NUMBER.equals(phoneUtil.parse("(1800) 7493.5247", RegionCode.US)))

  // Check that the last instance of an extension token is matched.
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  var extnNumber = ALPHA_NUMERIC_NUMBER.clone()
  extnNumber.setExtension("1234")
  assertTrue(extnNumber.equals(phoneUtil.parse("0~0 1800 7493 5247 ~1234", RegionCode.PL)))
  ...
  assertTrue(ukNumber.equals(phoneUtil.parse("+44 2034567890x456", RegionCode.NZ)))
  assertTrue(ukNumber.equals(phoneUtil.parse("+44 2034567890x456", RegionCode.GB)))
  assertTrue(ukNumber.equals(phoneUtil.parse("+44 2034567890 x456", RegionCode.GB)))
  assertTrue(ukNumber.equals(phoneUtil.parse("+44 2034567890 X456", RegionCode.GB)))
  assertTrue(ukNumber.equals(phoneUtil.parse("+44 2034567890 X 456", RegionCode.GB)))
  assertTrue(ukNumber.equals(phoneUtil.parse("+44 2034567890 X  456", RegionCode.GB)))
  assertTrue(ukNumber.equals(phoneUtil.parse("+44 2034567890 x 456  ", RegionCode.GB)))
  assertTrue(ukNumber.equals(phoneUtil.parse("+44 2034567890  X 456", RegionCode.GB)))
  assertTrue(ukNumber.equals(phoneUtil.parse("+44-2034567890;ext=456", RegionCode.GB)))
  assertTrue(
    ukNumber.equals(phoneUtil.parse("tel:2034567890;ext=456;phone-context=+44", RegionCode.ZZ))
  )
  // Full-width extension, 'extn' only.
  assertTrue(
    ukNumber.equals(phoneUtil.parse("+442034567890\uFF45\uFF58\uFF54\uFF4E456", RegionCode.GB))
  )
  // 'xtn' only.
  assertTrue(ukNumber.equals(phoneUtil.parse("+442034567890\uFF58\uFF54\uFF4E456", RegionCode.GB)))
  // 'xt' only.
  assertTrue(ukNumber.equals(phoneUtil.parse("+442034567890\uFF58\uFF54456", RegionCode.GB)))
  ...
  assertTrue(usWithExtension.equals(phoneUtil.parse("(800) 901-3355 x 7246433", RegionCode.US)))
  assertTrue(usWithExtension.equals(phoneUtil.parse("(800) 901-3355 , ext 7246433", RegionCode.US)))
  assertTrue(usWithExtension.equals(phoneUtil.parse("(800) 901-3355 ; 7246433", RegionCode.US)))
  // To test an extension character without surrounding spaces.
  assertTrue(usWithExtension.equals(phoneUtil.parse("(800) 901-3355;7246433", RegionCode.US)))
  assertTrue(
    usWithExtension.equals(phoneUtil.parse("(800) 901-3355 ,extension 7246433", RegionCode.US))
  )
  assertTrue(
    usWithExtension.equals(phoneUtil.parse("(800) 901-3355 ,extensi\u00F3n 7246433", RegionCode.US))
  )
  // Repeat with the small letter o with acute accent created by combining
  // characters.
  assertTrue(
    usWithExtension.equals(
  ...
  assertTrue(ruWithExtension.equals(phoneUtil.parse("8 (423) 202-25-11, доб. 100", RegionCode.RU)))
  assertTrue(ruWithExtension.equals(phoneUtil.parse("8 (423) 202-25-11 доб. 100", RegionCode.RU)))
  assertTrue(ruWithExtension.equals(phoneUtil.parse("8 (423) 202-25-11, доб 100", RegionCode.RU)))
  assertTrue(ruWithExtension.equals(phoneUtil.parse("8 (423) 202-25-11 доб 100", RegionCode.RU)))
  assertTrue(ruWithExtension.equals(phoneUtil.parse("8 (423) 202-25-11доб100", RegionCode.RU)))
  // Testing in unicode format
  assertTrue(
    ruWithExtension.equals(
  ...
  assertTrue(ruWithExtension.equals(phoneUtil.parse("8 (423) 202-25-11ДОБ100", RegionCode.RU)))
  assertTrue(
    ruWithExtension.equals(phoneUtil.parse("8 (423) 202-25-11\u0414\u041E\u0411100", RegionCode.RU))
  )
  ...
  assertTrue(
    usWithTwoExtensionsNumber.equals(phoneUtil.parse("(212)123-1234 x508/x1234", RegionCode.US))
  )
  assertTrue(
    usWithTwoExtensionsNumber.equals(phoneUtil.parse("(212)123-1234 x508/ x1234", RegionCode.US))
  )
  ...
  assertTrue(usWithExtension.equals(phoneUtil.parse("+1 (645) 123 1234-910#", RegionCode.US)))
  // Retry with the same number in a slightly different format.
  assertTrue(usWithExtension.equals(phoneUtil.parse("+1 (645) 123 1234 ext. 910#", RegionCode.US)))
}
...
function testParseHandlesLongExtensionsWithExplicitLabels() {
  ...
  assertTrue(nzNumber.equals(phoneUtil.parse("tel:+6433316005;ext=0", RegionCode.NZ)))
  nzNumber.setExtension("01234567890123456789")
  assertTrue(
    nzNumber.equals(phoneUtil.parse("tel:+6433316005;ext=01234567890123456789", RegionCode.NZ))
  )
  // Extension too long.
  try {
  ...
  assertTrue(nzNumber.equals(phoneUtil.parse("03 3316005ext:1", RegionCode.NZ)))
  nzNumber.setExtension("12345678901234567890")
  assertTrue(nzNumber.equals(phoneUtil.parse("03 3316005 xtn:12345678901234567890", RegionCode.NZ)))
  assertTrue(
    nzNumber.equals(phoneUtil.parse("03 3316005 extension\t12345678901234567890", RegionCode.NZ))
  )
  assertTrue(
    nzNumber.equals(phoneUtil.parse("03 3316005 xtensio:12345678901234567890", RegionCode.NZ))
  )
  assertTrue(
    nzNumber.equals(phoneUtil.parse("03 3316005 xtensión, 12345678901234567890#", RegionCode.NZ))
  )
  assertTrue(
    nzNumber.equals(phoneUtil.parse("03 3316005extension.12345678901234567890", RegionCode.NZ))
  )
  assertTrue(nzNumber.equals(phoneUtil.parse("03 3316005 доб:12345678901234567890", RegionCode.NZ)))
  // Extension too long.
  try {
...
function testParseHandlesLongExtensionsWithAutoDiallingLabels() {
  ...
  assertTrue(
    usNumberUserInput.equals(phoneUtil.parse("+12679000000,,123456789012345#", RegionCode.US))
  )
  assertTrue(
    usNumberUserInput.equals(phoneUtil.parse("+12679000000;123456789012345#", RegionCode.US))
  )
  ...
  assertTrue(ukNumberUserInput.equals(phoneUtil.parse("+442034000000,,123456789#", RegionCode.GB)))
  // Extension too long.
  try {
...
function testParseHandlesShortExtensionsWithAmbiguousChar() {
  ...
  assertTrue(nzNumber.equals(phoneUtil.parse("03 3316005 x 123456789", RegionCode.NZ)))
  assertTrue(nzNumber.equals(phoneUtil.parse("03 3316005 x. 123456789", RegionCode.NZ)))
  assertTrue(nzNumber.equals(phoneUtil.parse("03 3316005 #123456789#", RegionCode.NZ)))
  assertTrue(nzNumber.equals(phoneUtil.parse("03 3316005 ~ 123456789", RegionCode.NZ)))
  // Extension too long.
  try {
...
function testParseHandlesShortExtensionsWhenNotSureOfLabel() {
  ...
  assertTrue(usNumber.equals(phoneUtil.parse("+1123-456-7890 666666#", RegionCode.US)))
  usNumber.setExtension("6")
  assertTrue(usNumber.equals(phoneUtil.parse("+11234567890-6#", RegionCode.US)))
  // Extension too long.
  try {
...
function testParseAndKeepRaw() {
  ...
  assertTrue(
    alphaNumericNumber.equals(phoneUtil.parseAndKeepRawInput("800 six-flags", RegionCode.US))
  )
  ...
  assertTrue(
    shorterAlphaNumber.equals(phoneUtil.parseAndKeepRawInput("+1800 six-flag", RegionCode.NZ))
  )
  ...
  assertTrue(
    alphaNumericNumber.equals(phoneUtil.parseAndKeepRawInput("001800 six-flag", RegionCode.NZ))
  )
  ...
  assertTrue(koreanNumber.equals(phoneUtil.parseAndKeepRawInput("08122123456", RegionCode.KR)))
}
...
function testParseWithPhoneContext() {
  ...
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("tel:033316005;phone-context=+64", RegionCode.ZZ)))
  assertTrue(
    NZ_NUMBER.equals(
      phoneUtil.parse(
  ...
  assertTrue(
    nzFromPhoneContext.equals(phoneUtil.parse("tel:033316005;phone-context=+64-3", RegionCode.ZZ))
  )
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  ...
  assertTrue(
    brFromPhoneContext.equals(phoneUtil.parse("tel:033316005;phone-context=+(555)", RegionCode.ZZ))
  )
  /** @type {!i18n.phonenumbers.PhoneNumber} */
  ...
  assertTrue(
    usFromPhoneContext.equals(
      phoneUtil.parse("tel:033316005;phone-context=+-1-2.3()", RegionCode.ZZ)
    )
  )

  // Valid domainname
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("tel:033316005;phone-context=abc.nz", RegionCode.NZ)))
  assertTrue(
    NZ_NUMBER.equals(
      phoneUtil.parse("tel:033316005;phone-context=www.PHONE-numb3r.com", RegionCode.NZ)
    )
  )
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("tel:033316005;phone-context=a", RegionCode.NZ)))
  assertTrue(
    NZ_NUMBER.equals(phoneUtil.parse("tel:033316005;phone-context=3phone.J.", RegionCode.NZ))
  )
  assertTrue(NZ_NUMBER.equals(phoneUtil.parse("tel:033316005;phone-context=a--z", RegionCode.NZ)))
...
function testUnknownCountryCallingCode() {
  ...
  assertEquals("+212345", phoneUtil.format(UNKNOWN_COUNTRY_CODE_NO_RAW_INPUT, PNF.E164))
}
...
function testIsNumberMatchMatches() {
  ...
  assertEquals(
    i18n.phonenumbers.PhoneNumberUtil.MatchType.EXACT_MATCH,
    phoneUtil.isNumberMatch("+7 423 202-25-11 ext 100", "+7 4232022511 доб. 100")
  )
  // Test proto buffers.
  assertEquals(
    i18n.phonenumbers.PhoneNumberUtil.MatchType.EXACT_MATCH,
