...
i18n.phonenumbers.metadata.countryToMetadata = {
  ...
  AR: [
    ...
    [
      ...
      [, "(\\d)(\\d{4})(\\d{2})(\\d{4})", "$2 $3-$4", ["9(?:1[02-9]|[23])"], "0$1", "0$1 $CC"],
  ...
  AU: [
    ...
    ,
    [
      [, "(\\d{4})(\\d{3})(\\d{3})", "$1 $2 $3", ["1"], "$1"],
      [, "(\\d)(\\d{4})(\\d{4})", "$1 $2 $3", ["[2-478]"], "0$1"]
    ],
    ,
    [, , , , , , , , , [-1]],
    ,
  ...
  BS: [
    ,
    [, , "(242|8(00|66|77|88)|900)\\d{7}", , , , , , , [10], [7]],
    [
      ,
      ,
  ...
  CN: [
    ,
    [, , "[1-7]\\d{6,11}|8[0-357-9]\\d{6,9}|9\\d{7,10}", , , , , , , [11]],
    [, , "[2-9]\\d{10}", , , , "91234567"],
  ...
  DE: [
    ...
    ,
    [
      [, "(\\d{3})(\\d{3,8})", "$1 $2", ["2|3[3-9]|906|[4-9][1-9]1"], "0$1"],
      [, "(\\d{2})(\\d{4,11})", "$1/$2", ["[34]0|[68]9"], "0$1"],
      [, "(\\d{2})(\\d{2})", "$1 $2", ["[4-9]", "[4-6]|[7-9](?:\\d[1-9]|[1-9]\\d)"], "0$1"],
      [, "(\\d{4})(\\d{2,7})", "$1 $2", ["[4-9]", "[4-6]|[7-9](?:\\d[1-9]|[1-9]\\d)"], "0$1"],
      [, "(\\d{3})(\\d{1})(\\d{6})", "$1 $2 $3", ["800"], "0$1"],
      [, "(\\d{3})(\\d{3,4})(\\d{4})", "$1 $2 $3", ["900"], "0$1"]
    ],
    ,
    [, , , , , , , , , [-1]],
    ,
  ...
  GB: [
    ...
    ,
    [
      [, "(\\d{2})(\\d{4})(\\d{4})", "$1 $2 $3", ["[1-59]|[78]0"], "(0$1)"],
  ...
  JP: [
    ,
    [, , "07\\d{5}|[1-357-9]\\d{3,10}", , , , , , , [4, 5, 6, 7, 8, 9, 10, 11]],
    ...
    [
      ...
      [, "(\\d{2})(\\d{2})(\\d{3})(\\d{4})", "$1 $2 $3 $4", ["[57-9]0"], "0$1"],
      [
        ,
        "(\\d{2})(\\d{3})(\\d{4})",
        "$1 $2 $3",
  ...
  KR: [
    ,
    [, , "[1-7]\\d{3,9}|8\\d{8}", , , , , , , [4, 5, 6, 7, 8, 9, 10]],
    ...
    [
      ...
      [
        ...
        "(\\d)(\\d{4})(\\d{4})",
        "$1-$2-$3",
        ["2(?:[26]|3[0-467])", "2(?:[26]|3(?:01|1[45]|2[17-9]|39|4|6[67]|7[078]))"],
        "0$1"
      ],
      [
        ,
      ...
      [, "(\\d)(\\d{3})", "$1-$2", ["21[0-46-9]", "21(?:[0-247-9]|3[124]|6[1269])"], "0$1"],
      [, "(\\d)(\\d{4})", "$1-$2", ["21[36]", "21(?:3[035-9]|6[03-578])"], "0$1"],
      [
        ,
        "(\\d{2})(\\d{3})",
        "$1-$2",
        ["[3-6][1-9]1", "[3-6][1-9]1(?:[0-46-9])", "[3-6][1-9]1(?:[0-247-9]|3[124]|6[1269])"],
        "0$1"
      ],
      [
        ,
        "(\\d{2})(\\d{4})",
        "$1-$2",
        ["[3-6][1-9]1", "[3-6][1-9]1[36]", "[3-6][1-9]1(?:3[035-9]|6[03-578])"],
        "0$1"
      ]
    ],
    ,
  ...
  MX: [
    ...
    ,
    [
      [, "(\\d{3})(\\d{3})(\\d{4})", "$1 $2 $3", ["[89]00"], "01 $1", , 1],
      [, "(\\d{3})(\\d{2})(\\d{5})", "$2 $3", ["901"], "01 $1", , 1],
      [, "(\\d{2})(\\d{4})(\\d{4})", "$1 $2 $3", ["33|55|81"], "01 $1", , 1],
      [
        ,
        "(\\d{3})(\\d{3})(\\d{4})",
        "$1 $2 $3",
      ...
      [, "(\\d)(\\d{2})(\\d{4})(\\d{4})", "045 $2 $3 $4", ["1(?:33|55|81)"], "$1", , 1],
      [
        ,
        "(\\d)(\\d{3})(\\d{3})(\\d{4})",
        "045 $2 $3 $4",
